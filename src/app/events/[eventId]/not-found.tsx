...
export default function NotFound() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-6 text-white">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/[0.06] blur-[120px]" />
      ...
      <div className="relative z-10 mx-auto max-w-2xl text-center">
        ...
        <div className="mt-10">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-3 rounded-full bg-primary px-8 py-4 text-sm font-bold text-white transition duration-300 hover:bg-primary-dark"
          >
            <span>
              Back to Discovery
            </span>
