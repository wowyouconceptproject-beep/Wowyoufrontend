...
const sections = [
  {
    ...
    paragraphs: [
      ...
      "EventOS is operated by WoWYou Concepts Ltd. The platform may be used by event organisers, enterprise customers, public sector bodies, associations, venues, agencies, sponsors, vendors and attendees in Ireland, the United Kingdom, European markets and selected African markets.",
      "This Policy applies to ticketing and registration transactions processed or managed through EventOS. It should be read together with the EventOS Terms of Service, Privacy Policy, Acceptable Use Policy, Marketplace Terms and any event-specific terms published by the event organiser.",
    ],
  },

  {
    ...
    bullets: [
      ...
      "Event Organiser / Organiser: the person or organisation creating, promoting, managing or delivering an event through EventOS.",
      "EventOS / Platform: the WoWYou EventTech EventOS software platform operated by WoWYou Concepts Ltd.",
      ...
      "Platform Fees: fees charged by WoWYou Concepts Ltd for ticketing, booking, processing, service, subscription, AI, marketplace or related platform services.",
      "Payment Processor Fees: fees charged by third-party payment providers, banks, card networks or financial service providers.",
      "Refund Window: the period during which an attendee may request a refund under an organiser's published refund settings or applicable law.",
    ],
  },

  {
    title: "3. Platform Role and Organiser Responsibility",
    paragraphs: [
      "Unless WoWYou Concepts Ltd is clearly stated to be the event organiser, EventOS acts as a technology platform that enables organisers to sell, manage and validate tickets.",
      "The event organiser is responsible for the event itself and for setting and honouring its event-specific refund and cancellation terms, subject always to applicable consumer law.",
      "EventOS may facilitate refund processing, notifications and ticket status changes through the platform, but it does not assume responsibility for the organiser's event unless expressly stated.",
      "Where WoWYou Concepts Ltd is the organiser, the WoWYou organiser refund terms in this Policy will apply in addition to any event-specific terms.",
    ],
    bullets: [
      "The organiser is responsible for event delivery, cancellation decisions, postponements, changes, admission rules, venue requirements, accessibility arrangements and attendee communications.",
      "The organiser must publish clear refund terms before tickets are made available for purchase or registration.",
    ],
  },

  {
    ...
    bullets: [
      ...
      "EventOS and organisers may apply anti-fraud checks before issuing refunds.",
    ],
  },
...

  {
    ...
    paragraphs: [
      "EventOS allows organisers to choose and publish an appropriate refund setting before tickets go on sale. Organisers may also configure custom terms, provided those terms are lawful, transparent and not unfair.",
    ],
    bullets: [
      ...
      "Custom: Attendees should refer to the organiser's event-specific refund terms.",
    ],
  },

  {
    ...
    paragraphs: [
      "Where the organiser's published refund setting allows attendee-requested refunds, attendees may submit a refund request through EventOS or through the contact method specified on the event page.",
      "The organiser is responsible for approving or rejecting attendee-requested refunds unless the event is operated directly by WoWYou Concepts Ltd. EventOS may provide workflow tools, templates and status notifications.",
    ],
    bullets: [
...

  {
    ...
    paragraphs: [
      "If an organiser cancels an event and does not provide the event, attendees may be entitled to a refund under the organiser's terms and applicable consumer law.",
      "Where an event is cancelled, the organiser must promptly notify attendees and EventOS and provide clear information about available remedies.",
      ...
      "Organisers must not use a 'no refunds' statement to avoid obligations arising from cancellation, failure to deliver the event or mandatory consumer protection rules.",
    ],
    bullets: [
...

  {
    ...
    paragraphs: [
      "If an event is postponed or rescheduled, the organiser must notify attendees as soon as reasonably possible and provide the new date, time, venue and any material changes.",
      "The organiser should give attendees a reasonable period to choose between keeping their ticket for the new date or requesting a refund where required by law, the organiser's terms or the nature of the change.",
...

  {
    ...
    paragraphs: [
      ...
      "If a material change occurs, the organiser must inform attendees and explain whether refunds, transfers or credits are available.",
      "EventOS may support a material-change notification workflow and allow organisers to set a response deadline.",
    ],
  },

  {
    ...
    paragraphs: [
      "For online or hybrid events, refunds may be appropriate where the organiser fails to provide access credentials, the streaming link does not work due to organiser or platform fault, or the event is not delivered substantially as described.",
...

  {
    ...
    paragraphs: [
      "Unless the organiser's event-specific terms provide otherwise, refunds are not usually available where an attendee does not attend, arrives late and is refused or limited entry under published rules, is refused entry for breaching clearly disclosed requirements, or is removed from an event for misconduct or breach of event rules.",
      "This does not affect statutory rights where the organiser failed to provide the event or where terms were not properly disclosed.",
    ],
    bullets: [
...

  {
    ...
    paragraphs: [
      "Organisers should consider refunding accidental duplicate purchases where the attendee contacts the organiser within a reasonable period and the duplicate tickets have not been used, transferred or resold.",
      ...
      "Refunds for duplicate purchases remain subject to organiser approval and applicable law.",
    ],
  },

  {
    ...
    paragraphs: [
      "Organisers may choose whether tickets are transferable. EventOS should make transfer rules clear before checkout and in the ticket confirmation.",
...

  {
    ...
    paragraphs: [
      ...
      "Refunds will usually be made to the original payment method. If this is not possible, EventOS or the organiser may request an alternative lawful refund method.",
...

  {
    ...
    paragraphs: [
      "Attendees should first contact the organiser or EventOS support before starting a chargeback or payment dispute, where practical.",
      "EventOS may suspend tickets, delay payouts, pause organiser withdrawals or hold a refund reserve where there are chargebacks, fraud indicators, unresolved refund claims, regulatory concerns or event cancellation risk.",
  ...
  {
    title: "18. Payout Holds and Refund Reserves for Organisers",
    paragraphs: [
      "To protect attendees, organisers and the platform, EventOS may hold ticket proceeds or maintain a refund reserve before releasing funds to organisers.",
      "This is especially important for high-risk events, first-time organisers, large events, events with long lead times, unusual sales patterns, high dispute rates or events in markets with elevated payment risk.",
      "The amount and duration of any reserve may depend on event risk, sales volume, refund exposure, chargeback risk, organiser history, payment provider requirements and applicable law.",
    ],
  },

  {
    ...
    paragraphs: [
      ...
      "Where force majeure affects an event, the organiser must communicate promptly with attendees and explain whether the event is cancelled, postponed, rescheduled, moved online, converted to credit or otherwise addressed.",
      "Any remedy must comply with applicable law and the organiser's published terms.",
    ],
  },

  {
    ...
    paragraphs: [
      "Organisers are responsible for providing clear information about venue accessibility, event accessibility, age restrictions, entry requirements and any reasonable accommodation process.",
      "Where an attendee cannot access an event because the organiser failed to provide clearly promised accessibility arrangements or because accessibility information was materially inaccurate, a refund or other remedy may be required under applicable law.",
    ],
  },
...

  {
    ...
    paragraphs: [
      "For Ireland and EU/EEA consumers, EventOS and organisers should respect consumer protection rules, including requirements for clear pre-contract information, transparent total pricing and remedies where services are not provided as described.",
...

  {
    ...
    paragraphs: [
      "For UK consumers, EventOS and organisers should respect UK consumer protection rules, including clear upfront pricing, prohibition of misleading practices and ticketing-specific obligations.",
  ...
  {
    title: "22. Where WoWYou Concepts Ltd Is the Event Organiser",
    paragraphs: [
      "Where WoWYou Concepts Ltd is expressly identified as the event organiser, WoWYou Concepts Ltd will apply the event-specific refund terms shown at checkout and will comply with applicable consumer law.",
...

  {
    ...
    paragraphs: [
      "Attendees may request a refund by using the refund request function in EventOS, if available, or by contacting the organiser using the contact details on the event page or ticket confirmation.",
      "The organiser is normally responsible for reviewing the request and deciding whether it should be approved, rejected or followed up with a request for additional information.",
    ],
    bullets: [
      "Open ticket or order details.",
      "Select 'Request Refund'.",
      "Review the organiser's refund terms and deadline, if any.",
      "Submit the reason and any optional supporting evidence.",
      "The organiser reviews the request and approves, rejects or requests more information.",
...

  {
    ...
    paragraphs: [
      "If an attendee is dissatisfied with a refund decision, they should first contact the event organiser.",
      "If the issue relates to payment processing, platform functionality, duplicate charging or EventOS operation, attendees may contact WoWYou Concepts Ltd support.",
...

  {
    ...
    paragraphs: [
      "WoWYou Concepts Ltd may update this Policy from time to time to reflect changes in the platform, payment systems, consumer law, international operations, refund processes or business model.",
      "The latest version should be made available on the EventOS website or app.",
      "Material changes should be communicated to organisers and enterprise customers.",
...

  {
    title: "26. Contact",
    paragraphs: [
      "Refund questions about a specific event should be directed to the event organiser using the contact details on the event page or ticket confirmation.",
      "For platform support questions, contact WoWYou Concepts Ltd.",
