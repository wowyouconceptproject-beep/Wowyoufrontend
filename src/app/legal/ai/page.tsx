...
const sections = [
...

  {
    title: "2. Scope",
    paragraphs: [
      "This Policy applies to all AI-powered or AI-assisted functionality provided through EventOS, whether accessed through the website, mobile app, organizer dashboard, attendee interface, enterprise portal, API, marketplace or support channels.",
      "It applies to wowyou concepts staff, contractors, developers and support personnel, event organizers, enterprise customers, public sector customers, venues, agencies, associations, attendees, speakers, sponsors, exhibitors, vendors, volunteers, guests, integration partners, marketplace partners and any person or organisation using or configuring EventOS AI features.",
    ],
  },
...

  {
    ...
    paragraphs: [
      "wowyou concepts is responsible for designing, operating and improving EventOS AI features in a responsible manner.",
      "Event organizers and enterprise customers are responsible for how they configure, deploy and use AI features within their own events and attendee relationships.",
...

  {
    ...
    bullets: [
      ...
      "Accountability: wowyou concepts and event organizers should be able to explain who is responsible for AI configuration, review and outcomes.",
...

  {
    ...
    paragraphs: [
      ...
      "Event organizers should disclose to attendees when AI is used for attendee matching, recommendations, event support, analytics, personalised suggestions or automated messaging. Such disclosure may be included in the event privacy notice, registration page, mobile app notice or attendee terms.",
...

  {
    ...
    paragraphs: [
      ...
      "wowyou concepts does not guarantee that AI features will be error-free, uninterrupted, legally sufficient, commercially successful or suitable for every event type or jurisdiction.",
    ],
  },

  {
    ...
    bullets: [
      ...
      "Assisting organizers with timelines, reminders, planning checklists and operational tasks.",
...

  {
    ...
    paragraphs: [
      ...
      "wowyou concepts will not use customer event data or attendee personal data to train general-purpose AI models unless this is expressly agreed with the customer and supported by appropriate legal documentation.",
...

  {
    ...
    paragraphs: [
      ...
      "AI-generated content must not be used to mislead attendees about event details, speaker attendance, pricing, availability, endorsements, sponsors, refund policies or organizer identity.",
    ],
  },

  {
    ...
    paragraphs: [
      ...
      "organizers must not use AI matching to exclude, rank or disadvantage individuals unfairly.",
    ],
  },
...

  {
    ...
    paragraphs: [
      ...
      "wowyou concepts will assess such providers for security, privacy, contractual protections, data retention, international transfers, confidentiality and service reliability.",
...

  {
    ...
    paragraphs: [
      "Users should report unsafe, inaccurate, biased, discriminatory, unlawful or inappropriate AI outputs to wowyou concepts or the event organizer as soon as possible.",
      "wowyou concepts may investigate reports, remove or disable AI outputs, suspend accounts, restrict features, update prompts, modify model settings, engage AI providers or apply other remediation steps.",
      ...
      "Where an incident may raise wider legal or safety concerns, wowyou concepts may notify relevant customers, authorities or affected individuals where required by law.",
    ],
  },

  {
    title: "20. Customer and organizer Responsibilities",
    paragraphs: [
      "Customers and event organizers are responsible for using AI features appropriately within their events, audiences and jurisdictions.",
    ],
    bullets: [
...

  {
    ...
    paragraphs: [
      "wowyou concepts should maintain an internal AI governance process appropriate to the maturity of EventOS.",
...

  {
    ...
    paragraphs: [
      "wowyou concepts may restrict, suspend or terminate access to AI features or the wider EventOS platform where users breach this Policy, misuse AI features, create legal or security risk, infringe rights, endanger users or expose the company or its customers to unacceptable risk.",
...

  {
    ...
    paragraphs: [
      ...
      "wowyou concepts may update this Policy from time to time. Material changes should be communicated to customers and users where appropriate.",
    ],
  },

  {
    title: "25. Contact",
    paragraphs: [
      "For questions, complaints or reports relating to AI features, contact wowyou concepts.",
